...
def make_interpreter(extra_funcs=None):
...
################ expand
    ...
    def let(*args):
        ...
        return [[_lambda, list(vars)]+ [y for y in map(expand, body)]] + [w for w in map(expand, vals)]
    ...
    def parse(inport):
        ...
        return expand(read(inport, quotes), toplevel=True)
