...
# class InPortList(object):
#     "An input port. Retains a line of chars."
#     tokenizer = r"""\s*(,@|[('`,)]|"(?:[\\].|[^\\"])*"|;.*|[^\s('"`,;)]*)(.*)"""
#     def __init__(self, list_structure):
...
# def my_read_lists(inport):
#     "Read a Scheme expression from an input port."


#     def convert_obj(obj):
#         if isinstance(obj, list):
#             return map(convert_obj, obj) #call on itself recursively
#         elif obj in quotes:
#             #this is where I need to advance forward, don't know how with lists
#             return [quotes[obj], read(inport)]
#         else:
#             return atom(
